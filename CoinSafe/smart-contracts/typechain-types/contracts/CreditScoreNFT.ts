...
export interface CreditScoreNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "authorizedUpdaters"
  ...
  encodeFunctionData(
    functionFragment: "userScoreContract",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace CreditScoreUpdatedEvent {
  ...
  export type OutputTuple = [user: string, newScore: bigint, tokenId: bigint];
  export interface OutputObject {
    user: string;
    newScore: bigint;
    tokenId: bigint;
...
export interface CreditScoreNFT extends BaseContract {
  connect(runner?: ContractRunner | null): CreditScoreNFT;
  waitForDeployment(): Promise<this>;

  interface: CreditScoreNFTInterface;
  ...
  creditScores: TypedContractMethod<
    [arg0: AddressLike],
    [[bigint, bigint] & { score: bigint; lastUpdateTime: bigint }],
    "view"
  >;
  ...
  initialOwner: TypedContractMethod<[], [string], "view">;
  ...
  userScoreContract: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "userScoreContract"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
